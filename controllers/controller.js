...
//methode POST - tester connexion
exports.test_connexionPOST = function(req, res) {
    //Si la requete client abouti, on lui repond simplement pour confirmer que la connexion est etablie
    
    setTimeout(function() {
        res.json({ etat_connexion: true});
    }, 3000);
